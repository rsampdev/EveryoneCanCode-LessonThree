...
let name = "Sampson"
let numberOfDollars = 22
let adjective = "green"
let thingToBuy = "computer mouse"
let placeType = "Computer Supply"
let place = "Shop"
let positiveEmotion = "happy"
let negativeEmotion = "sad"
let thingNameisOutOf = "money"

let story: String = "Today was a big day for \(name). They had finally saved up \(numberOfDollars) dollars and were going to buy a \(adjective) \(thingToBuy). They went to the \(placeType) \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). They were all out of \(thingNameisOutOf)!"
